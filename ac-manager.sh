...
uninstall_server() {
    ...
    case "$choice" in
        ...
        1)
            ...
            echo "The database and client data (Docker volumes) will be preserved,"
            echo "so a future reinstall picks up right where this left off."
            echo
        ...
        2)
            ...
            echo
            warning "This will delete the complete server, the database, and all Docker volumes."
            echo
